...
Ralph can be run in a containerized environment. See [DOCKER.md](DOCKER.md) for detailed instructions.
...
The Docker setup uses named volumes for rootless Docker compatibility and includes all necessary dependencies.
